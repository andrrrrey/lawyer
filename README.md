...
заказчика и сквозной маркетинговой аналитики (Битрикс24, Яндекс Директ/Метрика,
Calltouch, МойСклад). Разрабатывается по ТЗ (Этап 1). Утверждённый визуальный
...
- Доступы к интеграциям (Битрикс24, Директ, Метрика, Calltouch, МойСклад) и
